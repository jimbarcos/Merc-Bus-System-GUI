Public Class Minigame_ui
    'music shared between forms
    ...
    'color rest change when cursor leaves range
    ...
    'when user choose to go to right arrow
    ...
    'when user choose to go to left arrow
    ...
    'when user click the picture gif image of minigame
    ...
    'back btn and resetting values of form 1
    ...
    ' default load 
    Private Sub Minigame_ui_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim enabled As String = Nothing
